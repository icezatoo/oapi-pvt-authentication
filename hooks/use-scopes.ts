...
const nextPass: Scopes[] = [
  ...
  { id: 'nextpass.office_address', name: 'Office Address', description: 'Access to user office_address information', required: false },
  { id: 'nextpass.work_profile', name: 'Work Profile', description: 'Access to user work_profile information', required: false },
